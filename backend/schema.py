...
CREATE TABLE IF NOT EXISTS society_banners (id TEXT PRIMARY KEY, society_id TEXT NOT NULL, title TEXT, body TEXT, image_url TEXT, bg_color TEXT DEFAULT '#6c5ce7', cta_text TEXT, cta_url TEXT, is_active INTEGER DEFAULT 1, sort_order INTEGER DEFAULT 0, expires_at DATETIME, created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS advertisements (id TEXT PRIMARY KEY, society_id TEXT NOT NULL, headline TEXT NOT NULL, subtext TEXT, image_url TEXT, bg_color TEXT DEFAULT '#1a1a2e', cta_text TEXT, cta_url TEXT, advertiser TEXT, is_active INTEGER DEFAULT 1, sort_order INTEGER DEFAULT 0, expires_at DATETIME, created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS society_news (id TEXT PRIMARY KEY, society_id TEXT NOT NULL, author_id TEXT NOT NULL, title TEXT NOT NULL, body TEXT, images TEXT, is_pinned INTEGER DEFAULT 0, category TEXT DEFAULT 'society', created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE IF NOT EXISTS lease_doc_requirements (id TEXT PRIMARY KEY, society_id TEXT NOT NULL, doc_type TEXT NOT NULL, is_mandatory INTEGER DEFAULT 1, created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS lease_documents (id TEXT PRIMARY KEY, lease_extension_id TEXT NOT NULL, society_id TEXT NOT NULL, doc_type TEXT NOT NULL, file_name TEXT, data TEXT, status TEXT DEFAULT 'pending', created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
